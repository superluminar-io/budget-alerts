    ...
    Records: [
      {
        ...
        eventSource: 'aws:sqs',
        eventSourceARN: 'arn:aws:sqs:eu-west-1:444444444444:test',
        awsRegion: 'eu-west-1',
      },
    ],
  };
